...
from .views import show_game, set_score, set_score_normal, set_score_hard, get_score_normal, get_score_hard, fetch_unread_message_count
urlpatterns = [
    ...
    path('fetch_unread_message_count/', fetch_unread_message_count, name='fetch_unread_message_count'),
]
